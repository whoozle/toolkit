...
#define TOOLKIT_FORWARD_DECLARE_CLASS_WPTR(NS, NAME) TOOLKIT_FORWARD_DECLARE(NS, class, NAME, TOOLKIT_DECLARE_PTR(NAME) ; TOOLKIT_DECLARE_WEAK_PTR(NAME) ;)
...
#define TOOLKIT_FORWARD_DECLARE_INTERFACE(NS, NAME) TOOLKIT_FORWARD_DECLARE(NS, struct, NAME, TOOLKIT_DECLARE_PTR(NAME) ; )
#define TOOLKIT_FORWARD_DECLARE_INTERFACE_CPTR(NS, NAME) TOOLKIT_FORWARD_DECLARE(NS, struct, NAME, TOOLKIT_DECLARE_PTR(NAME) ; TOOLKIT_DECLARE_CONST_PTR(NAME) ; )
