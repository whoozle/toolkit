...
namespace TOOLKIT_NS { namespace raster
{
	...
	using RGB565	= impl::PixelFormat<u16,  11, 5,  5, 6,  0,  5,  0,  0>;
	using BGR565	= impl::PixelFormat<u16,  0,  5,  5, 6,  11, 5,  0,  0>;
	using RGB555	= impl::PixelFormat<u16,  10, 5,  5, 5,  0,  5,  0,  0>;
